...
$(document).ready(function () {
    ...
    function Move() {
        ...
        if ($bg2.hasClass("inview")) {
            bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, -600, -0.25)});
        }
        if ($bg3.hasClass("inview")) {
            bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 1200, 0.08)});
        }
        if ($bg4.hasClass("inview")) {
            bg4.css({'backgroundPosition': newPos(50, windowHeight, pos, 300, -0.2)});
        }
        if ($bg5.hasClass("inview")) {
            bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 2000, 0.1)});
        }
        if ($bg6.hasClass("inview")) {
            bg6.css({'backgroundPosition': newPos(50, windowHeight, pos, -800, -0.25)});
        }
        if ($bg7.hasClass("inview")) {
            bg7.css({'backgroundPosition': newPos(50, windowHeight, pos, -1200, -0.4)});
        }
        ...
        if ($bg10.hasClass("inview")) {
            bg10.css({'backgroundPosition': newPos(50, windowHeight, pos, 1400, -0.21)});
        }
        if ($bg11.hasClass("inview")) {
            bg11.css({'backgroundPosition': newPos(50, windowHeight, pos, -800, 0.15)});
        }
